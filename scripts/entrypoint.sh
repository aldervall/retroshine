...
# config) AND log_to_file = "true". The --log-file flag alone and appendconfig don't work.
# Patch both into the main cfg here so the crash log appears at /tmp/retroarch.log.
